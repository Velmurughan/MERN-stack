  ...
  return (
    ...
    <div className='bg-blue-200 flex flex-col justify-center rounded-xl items-center min-h-screen'>
      ...
      <div className={`bg-[#FFF] ${switchLayout ? "hidden" : "grid"} h-[30rem] w-[50rem] rounded-xl grid grid-cols-2 shadow-lg mt-4`}>
        <div className='bg-amber-400 grid grid-col justify-center items-center text-center p-8 rounded-xl'>
          ...
          <div>
            <form className="max-w-md mx-auto">
              <div className="relative z-0 w-full mb-5 group">
                <input type="email" name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-amber-400 focus:outline-none focus:ring-0 focus:border-amber-400 peer" placeholder=" " required />
              ...
              <div className="relative z-0 w-full mb-5 group">
                <input type="password" name="floating_password" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-amber-400 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
              ...
              <button type="submit" className="text-white bg-amber-700 hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-red-800">Submit</button>
            </form>
        ...
        <div className='bg-white-400 flex flex-col p-[2.5rem] gap-4 items-center  rounded-xl flex-nowrap'>
          ...
          <div>
            <form className="max-w-md mx-auto">
              ...
              <button type="submit" className="text-white bg-amber-700 hover:bg-amber -800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Submit</button>
            </form>

          </div>

        </div>
        <div className=' bg-amber-400 grid grid-col rounded-xl gap-4 justify-center items-center text-center p-8'>
